/*
    ...
    These define our class, it's FIELDS and METHODS, similar to function
   prototypes
*/
...
class Shape {
protected: // protected fields/methods are accessible within this class and any
           // subclasses
  // fields
  double height;
  double width;
...
public: // accessible everywhere
  // fields
  static int
      numOfShapes; // static means it's a CLASS field, not an OBJECT field
  ...
  static int
  GetNumOfShapes(); // we need a static method to access a static field

  virtual double Area(); // virtual means the method can be overriden
